...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ip_blocking_ipblock', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(unique=True, max_length=15, db_index=True)),
            ('moderator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')()),
            ('note', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('ip_blocking', ['IPBlock'])


    def backwards(self, orm):
        
        # Deleting model 'IPBlock'
        db.delete_table('ip_blocking_ipblock')
