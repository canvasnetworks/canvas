...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SpotlightedThread'
        db.create_table('logged_out_homepage_spotlightedthread', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='spotlighted_threads', to=orm['canvas.Comment'])),
            ('curator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='spotlighted_threads', null=True, blank=True, to=orm['auth.User'])),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')(default=0)),
            ('sort', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('logged_out_homepage', ['SpotlightedThread'])


    def backwards(self, orm):
        
        # Deleting model 'SpotlightedThread'
        db.delete_table('logged_out_homepage_spotlightedthread')
    ...
    models = {
        ...
        'logged_out_homepage.spotlightedthread': {
            'Meta': {'object_name': 'SpotlightedThread'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'spotlighted_threads'", 'to': "orm['canvas.Comment']"}),
            'curator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'spotlighted_threads'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['logged_out_homepage']
