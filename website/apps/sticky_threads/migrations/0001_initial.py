...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StickyThread'
        db.create_table('sticky_threads_stickythread', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sticky_threads', to=orm['canvas.Comment'])),
            ('curator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='sticky_threads', null=True, blank=True, to=orm['auth.User'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')(default=0)),
            ('sort', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('sticky_threads', ['StickyThread'])


    def backwards(self, orm):
        
        # Deleting model 'StickyThread'
        db.delete_table('sticky_threads_stickythread')
    ...
    models = {
        ...
        'sticky_threads.stickythread': {
            'Meta': {'ordering': "['sort']", 'object_name': 'StickyThread'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sticky_threads'", 'to': "orm['canvas.Comment']"}),
            'curator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'sticky_threads'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
