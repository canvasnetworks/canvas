...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('monster_mobileuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='device_tokens', to=orm['auth.User'])),
        ))
        db.send_create_signal('monster', ['MobileUser'])


    def backwards(self, orm):
        
        # Deleting model 'MobileUser'
        db.delete_table('monster_mobileuser')
    ...
    models = {
        ...
        'monster.mobileuser': {
            ...
            'device_token': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'device_tokens'", 'to': "orm['auth.User']"})
        },
