...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MonsterPart'
        db.create_table('monster_monsterpart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='monster_parts', to=orm['canvas.Comment'])),
            ('top', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='bottoms', null=True, blank=True, to=orm['monster.MonsterPart'])),
            ('hint_slice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Content'], null=True, blank=True)),
        ))
        db.send_create_signal('monster', ['MonsterPart'])


    def backwards(self, orm):
        
        # Deleting model 'MonsterPart'
        db.delete_table('monster_monsterpart')
