...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MonsterPart.top'
        db.delete_column('monster_monsterpart', 'top_id')


    def backwards(self, orm):
        
        # Adding field 'MonsterPart.top'
        db.add_column('monster_monsterpart', 'top', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='bottoms', null=True, to=orm['monster.MonsterPart'], blank=True), keep_default=False)
