...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.ot_hidden'
        db.add_column('canvas_comment', 'ot_hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.ot_hidden'
        db.delete_column('canvas_comment', 'ot_hidden')
