...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.last_activity_check'
        db.add_column('canvas_userinfo', 'last_activity_check', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'UserInfo.last_activity_check'
        db.delete_column('canvas_userinfo', 'last_activity_check')
