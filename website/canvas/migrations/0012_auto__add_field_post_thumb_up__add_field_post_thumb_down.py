...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.thumb_up'
        db.add_column('canvas_post', 'thumb_up', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Post.thumb_down'
        db.add_column('canvas_post', 'thumb_down', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.thumb_up'
        db.delete_column('canvas_post', 'thumb_up')

        # Deleting field 'Post.thumb_down'
        db.delete_column('canvas_post', 'thumb_down')
