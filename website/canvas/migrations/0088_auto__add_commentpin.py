...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommentPin'
        db.create_table('canvas_commentpin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pins', to=orm['canvas.Comment'])),
            ('timestamp', self.gf('django.db.models.fields.FloatField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pins', to=orm['auth.User'])),
            ('auto', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('canvas', ['CommentPin'])


    def backwards(self, orm):
        
        # Deleting model 'CommentPin'
        db.delete_table('canvas_commentpin')
    ...
    models = {
        ...
        'canvas.commentpin': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pins'", 'to': "orm['canvas.Comment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.FloatField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pins'", 'to': "orm['auth.User']"})
        },
