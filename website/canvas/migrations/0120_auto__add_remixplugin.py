...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RemixPlugin'
        db.create_table('canvas_remixplugin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')(default=0)),
            ('s3url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('canvas', ['RemixPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'RemixPlugin'
        db.delete_table('canvas_remixplugin')
    ...
    models = {
        ...
        'canvas.remixplugin': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            's3url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'timestamp': ('canvas.util.UnixTimestampField', [], {'default': '0'})
        },
        'canvas.stashcontent': {
