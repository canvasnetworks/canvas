...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('canvas_comment', 'parent_id')

        db.rename_column('canvas_comment', 'text', 'reply_text')

        db.rename_column('canvas_comment', 'content_id', 'reply_content')

        # Adding field 'Comment.parent_content'
        db.add_column('canvas_comment', 'parent_content', self.gf('django.db.models.fields.CharField')(default='a', max_length=32), keep_default=False)
    ...
    models = {
        ...
        'canvas.comment': {
            ...
            'parent_content': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'reply_content': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
