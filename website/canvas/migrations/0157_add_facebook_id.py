...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.facebook_id'
        db.add_column('canvas_userinfo', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.facebook_id'
        db.delete_column('canvas_userinfo', 'facebook_id')
