...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Content.score'
        db.delete_column('canvas_content', 'score')


    def backwards(self, orm):
        
        # Adding field 'Content.score'
        db.add_column('canvas_content', 'score', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
