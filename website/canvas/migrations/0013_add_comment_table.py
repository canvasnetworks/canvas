...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_comment', (
            ('ip', self.gf('django.db.models.fields.IPAddressField')(default='0.0.0.0', max_length=15)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Comment'])),
            ...
            ('anonymous', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ...
        db.send_create_signal('canvas', ['Comment'])
    
    def backwards(self, orm):
        
        # Deleting model 'Comment'
        db.delete_table('canvas_comment')
    ...
    models = {
        ...
        'canvas.comment': {
            ...
            'comment_id': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canvas.Comment']"}),
