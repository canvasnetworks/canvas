...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('canvas_comment', 'parent_comment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='replies', null=True, blank=True, to=orm['canvas.Comment']), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Comment.parent_comment'
        db.delete_column('canvas_comment', 'parent_comment_id')
