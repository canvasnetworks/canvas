...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_userinfo', (
            ...
            ('free_invites', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('canvas', ['UserInfo'])

        # Adding model 'FacebookUser'
        db.create_table('canvas_facebookuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('fb_uid', self.gf('django.db.models.fields.BigIntegerField')(unique=True)),
        ))
        db.send_create_signal('canvas', ['FacebookUser'])

        # Changing field 'InviteCode.code'
        db.alter_column('canvas_invitecode', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))


    def backwards(self, orm):
        
        # Deleting model 'UserInfo'
        db.delete_table('canvas_userinfo')

        # Deleting model 'FacebookUser'
        db.delete_table('canvas_facebookuser')

        # Changing field 'InviteCode.code'
        db.alter_column('canvas_invitecode', 'code', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True))
