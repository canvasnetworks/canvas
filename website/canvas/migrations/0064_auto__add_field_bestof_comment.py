...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BestOf.comment'
        db.add_column('canvas_bestof', 'comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='best_of', null=True, to=orm['canvas.Comment']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BestOf.comment'
        db.delete_column('canvas_bestof', 'comment_id')
    ...
    models = {
        ...
        'canvas.bestof': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'best_of'", 'null': 'True', 'to': "orm['canvas.Comment']"}),
