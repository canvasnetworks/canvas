...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('canvas_hashtag')

        # Deleting model 'Thread'
        db.delete_table('canvas_thread')

        # Removing M2M table for field hashtags on 'Thread'
        db.delete_table('canvas_thread_hashtags')

        # Deleting model 'StashContent'
        db.delete_table('canvas_stashcontent')
