...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.enable_timeline'
        db.add_column('canvas_userinfo', 'enable_timeline', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.enable_timeline'
        db.delete_column('canvas_userinfo', 'enable_timeline')
