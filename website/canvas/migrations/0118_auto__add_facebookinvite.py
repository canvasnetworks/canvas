...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_facebookinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fb_message_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('invited_fbid', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('invitee', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='facebook_invited_from', null=True, blank=True, to=orm['auth.User'])),
            ('inviter', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='facebook_sent_invites', null=True, blank=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('canvas', ['FacebookInvite'])


    def backwards(self, orm):
        
        # Deleting model 'FacebookInvite'
        db.delete_table('canvas_facebookinvite')
