...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.is_qa'
        db.add_column('canvas_userinfo', 'is_qa', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.is_qa'
        db.delete_column('canvas_userinfo', 'is_qa')
