...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommentFlag.undone'
        db.add_column('canvas_commentflag', 'undone', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommentFlag.undone'
        db.delete_column('canvas_commentflag', 'undone')
