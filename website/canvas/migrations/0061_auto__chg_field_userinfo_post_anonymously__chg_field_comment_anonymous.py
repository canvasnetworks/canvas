...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Content.remix_text'
        db.add_column('canvas_content', 'remix_text', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Content.remix_text'
        db.delete_column('canvas_content', 'remix_text')
