...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BestOf'
        db.create_table('canvas_bestof', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Content'], unique=True)),
        ...
        db.send_create_signal('canvas', ['BestOf'])


    def backwards(self, orm):
        
        # Deleting model 'BestOf'
        db.delete_table('canvas_bestof')
    ...
    models = {
        ...
        'canvas.bestof': {
            ...
            'content': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canvas.Content']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
