...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ContentSticker'
        db.delete_table('canvas_contentsticker')

        # Adding field 'FacebookUser.last_invited'
        db.add_column('canvas_facebookuser', 'last_invited', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'ContentSticker'
        db.create_table('canvas_contentsticker', (
            ('type_id', self.gf('django.db.models.fields.IntegerField')()),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stickers', to=orm['canvas.Content'])),
        ...
        db.send_create_signal('canvas', ['ContentSticker'])

        # Deleting field 'FacebookUser.last_invited'
        db.delete_column('canvas_facebookuser', 'last_invited')
