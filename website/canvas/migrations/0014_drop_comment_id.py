...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('canvas_comment', 'comment_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Comment.comment_id'
        db.add_column('canvas_comment', 'comment_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
