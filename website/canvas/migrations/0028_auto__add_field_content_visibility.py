...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):        
        # Adding field 'Content.visibility'
        db.add_column('canvas_content', 'visibility', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.visibility'
        db.delete_column('canvas_content', 'visibility')
