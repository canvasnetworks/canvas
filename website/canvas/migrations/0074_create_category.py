...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('canvas', ['Category'])

        # Adding field 'Comment.category'
        db.add_column('canvas_comment', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='comments', null=True, blank=True, to=orm['canvas.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table('canvas_category')

        # Deleting field 'Comment.category'
        db.delete_column('canvas_comment', 'category_id')
