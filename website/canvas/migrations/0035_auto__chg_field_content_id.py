...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Content.id'
        db.alter_column('canvas_content', 'id', self.gf('django.db.models.fields.CharField')(max_length=40, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Content.id'
        db.alter_column('canvas_content', 'id', self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True))
