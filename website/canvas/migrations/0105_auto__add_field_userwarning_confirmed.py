...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserWarning.confirmed'
        db.add_column('canvas_userwarning', 'confirmed', self.gf('canvas.util.UnixTimestampField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserWarning.confirmed'
        db.delete_column('canvas_userwarning', 'confirmed')
