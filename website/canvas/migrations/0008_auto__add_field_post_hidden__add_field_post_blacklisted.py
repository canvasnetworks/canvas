...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('canvas_post', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Post.blacklisted'
        db.add_column('canvas_post', 'blacklisted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Post.hidden'
        db.delete_column('canvas_post', 'hidden')

        # Deleting field 'Post.blacklisted'
        db.delete_column('canvas_post', 'blacklisted')
