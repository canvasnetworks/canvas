...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_commentflag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flags', to=orm['canvas.Comment'])),
        ...
        db.send_create_signal('canvas', ['CommentFlag'])


    def backwards(self, orm):
        
        # Deleting model 'CommentFlag'
        db.delete_table('canvas_commentflag')
