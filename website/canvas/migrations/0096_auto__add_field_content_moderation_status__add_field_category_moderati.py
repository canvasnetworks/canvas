...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Content.moderation_status'
        db.add_column('canvas_content', 'moderation_status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Category.moderation_status'
        db.add_column('canvas_category', 'moderation_status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Comment.moderation_status'
        db.add_column('canvas_comment', 'moderation_status', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Content.moderation_status'
        db.delete_column('canvas_content', 'moderation_status')

        # Deleting field 'Category.moderation_status'
        db.delete_column('canvas_category', 'moderation_status')

        # Deleting field 'Comment.moderation_status'
        db.delete_column('canvas_comment', 'moderation_status')
    ...
    models = {
        ...
        'canvas.category': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moderation_status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
