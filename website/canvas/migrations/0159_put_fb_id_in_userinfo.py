...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for fbu in orm.FacebookUser.objects.all():
            if fbu.user is not None and fbu.user.userinfo is not None:
                fbu.user.userinfo.facebook_id = str(fbu.fb_uid)
                fbu.user.userinfo.save()
