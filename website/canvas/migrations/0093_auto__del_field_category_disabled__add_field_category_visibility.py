...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.disabled'
        db.delete_column('canvas_category', 'disabled')

        # Adding field 'Category.visibility'
        db.add_column('canvas_category', 'visibility', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Category.disabled'
        db.add_column('canvas_category', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Category.visibility'
        db.delete_column('canvas_category', 'visibility')
