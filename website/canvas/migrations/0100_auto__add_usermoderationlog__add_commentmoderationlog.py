...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserModerationLog'
        db.create_table('canvas_usermoderationlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='moderation_log', to=orm['auth.User'])),
        ...
        db.send_create_signal('canvas', ['UserModerationLog'])

        # Adding model 'CommentModerationLog'
        db.create_table('canvas_commentmoderationlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='moderated_comments_log', to=orm['auth.User'])),
            ('moderator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')()),
            ('note', self.gf('django.db.models.fields.TextField')()),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Comment'])),
            ('visibility', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('canvas', ['CommentModerationLog'])


    def backwards(self, orm):
        
        # Deleting model 'UserModerationLog'
        db.delete_table('canvas_usermoderationlog')

        # Deleting model 'CommentModerationLog'
        db.delete_table('canvas_commentmoderationlog')
