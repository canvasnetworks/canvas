...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.invite_bypass'
        db.add_column('canvas_userinfo', 'invite_bypass', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.invite_bypass'
        db.delete_column('canvas_userinfo', 'invite_bypass')
