...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.profile_image'
        db.add_column('canvas_userinfo', 'profile_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Comment'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.profile_image'
        db.delete_column('canvas_userinfo', 'profile_image_id')
