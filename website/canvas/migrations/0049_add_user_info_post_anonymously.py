...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Content.alpha'
        db.alter_column('canvas_content', 'alpha', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Content.animated'
        db.alter_column('canvas_content', 'animated', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'UserInfo.post_anonymously'
        db.add_column('canvas_userinfo', 'post_anonymously', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=True)

        # Changing field 'Comment.anonymous'
        db.alter_column('canvas_comment', 'anonymous', self.gf('django.db.models.fields.BooleanField')(blank=True))


    def backwards(self, orm):
        
        # Changing field 'Content.alpha'
        db.alter_column('canvas_content', 'alpha', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Content.animated'
        db.alter_column('canvas_content', 'animated', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'UserInfo.post_anonymously'
        db.delete_column('canvas_userinfo', 'post_anonymously')

        # Changing field 'Comment.anonymous'
        db.alter_column('canvas_comment', 'anonymous', self.gf('django.db.models.fields.BooleanField')())
