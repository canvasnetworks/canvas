...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ContentUrlMapping'
        db.create_table('canvas_contenturlmapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('canvas', ['ContentUrlMapping'])

        # Adding field 'Content.url_mapping'
        db.add_column('canvas_content', 'url_mapping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.ContentUrlMapping'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ContentUrlMapping'
        db.delete_table('canvas_contenturlmapping')

        # Deleting field 'Content.url_mapping'
        db.delete_column('canvas_content', 'url_mapping_id')
    ...
    models = {
        ...
        'canvas.post': {
            ...
            'anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'blacklisted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
