...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Category.founder'
        db.delete_column('canvas_category', 'founder_id')

        # Removing M2M table for field moderators on 'Category'
        db.delete_table('canvas_category_moderators')
