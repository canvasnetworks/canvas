...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BestOf.content'
        db.delete_column('canvas_bestof', 'content_id')


    def backwards(self, orm):
        
        # We cannot add back in field 'BestOf.content'
        raise RuntimeError(
            "Cannot reverse this migration. 'BestOf.content' and its values cannot be restored.")
