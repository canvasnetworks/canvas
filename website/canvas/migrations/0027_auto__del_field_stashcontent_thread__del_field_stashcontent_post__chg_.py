...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StashContent.thread'
        db.delete_column('canvas_stashcontent', 'thread_id')

        # Deleting field 'StashContent.post'
        db.delete_column('canvas_stashcontent', 'post')

        # Changing field 'StashContent.content_id'
        db.alter_column('canvas_stashcontent', 'content_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Content']))

        # Adding index on 'StashContent', fields ['content_id']
        db.create_index('canvas_stashcontent', ['content_id'])
    ...
    models = {
        ...
        'canvas.stashcontent': {
            ...
            'content_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canvas.Content']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
