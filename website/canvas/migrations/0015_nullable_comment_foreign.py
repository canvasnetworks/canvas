...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('canvas_comment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Comment'], null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Comment.parent'
        db.alter_column('canvas_comment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Comment']))
    ...
    models = {
        ...
        'canvas.comment': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['canvas.Comment']", 'null': 'True'}),
