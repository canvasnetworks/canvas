...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'APIApp'
        db.create_table('canvas_apiapp', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('canvas', ['APIApp'])

        # Adding model 'APIAuthToken'
        db.create_table('canvas_apiauthtoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.APIApp'])),
        ))
        db.send_create_signal('canvas', ['APIAuthToken'])


    def backwards(self, orm):
        
        # Deleting model 'APIApp'
        db.delete_table('canvas_apiapp')

        # Deleting model 'APIAuthToken'
        db.delete_table('canvas_apiauthtoken')
