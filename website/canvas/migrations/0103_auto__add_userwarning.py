...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserWarning'
        db.create_table('canvas_userwarning', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('issued', self.gf('canvas.util.UnixTimestampField')()),
            ('viewed', self.gf('canvas.util.UnixTimestampField')()),
            ('bantime', self.gf('django.db.models.fields.IntegerField')()),
            ('custom_message', self.gf('django.db.models.fields.TextField')()),
            ('stock_message', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('canvas', ['UserWarning'])


    def backwards(self, orm):
        
        # Deleting model 'UserWarning'
        db.delete_table('canvas_userwarning')
    ...
    models = {
        ...
        'canvas.userwarning': {
            ...
            'bantime': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'viewed': ('canvas.util.UnixTimestampField', [], {})
        },
