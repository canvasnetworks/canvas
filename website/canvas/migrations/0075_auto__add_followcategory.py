...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FollowCategory'
        db.create_table('canvas_followcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categories', to=orm['auth.User'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followers', to=orm['canvas.Category'])),
        ))
        db.send_create_signal('canvas', ['FollowCategory'])


    def backwards(self, orm):
        
        # Deleting model 'FollowCategory'
        db.delete_table('canvas_followcategory')
    ...
    models = {
        ...
        'canvas.followcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'categories'", 'to': "orm['auth.User']"})
        },
        'canvas.invitecode': {
