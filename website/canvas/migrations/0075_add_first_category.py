...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Category(name="drawing", description="Post original content, drawings to finish, or just talk about drawing.").save()

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Category.objects.get(name="drawing").delete()
