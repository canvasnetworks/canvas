...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommentSticker'
        db.create_table('canvas_commentsticker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stickers', to=orm['canvas.Comment'])),
        ...
        db.send_create_signal('canvas', ['CommentSticker'])


    def backwards(self, orm):
        
        # Deleting model 'CommentSticker'
        db.delete_table('canvas_commentsticker')
