...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WelcomeEmailRecipient'
        db.create_table('canvas_welcomeemailrecipient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('canvas', ['WelcomeEmailRecipient'])


    def backwards(self, orm):
        
        # Deleting model 'WelcomeEmailRecipient'
        db.delete_table('canvas_welcomeemailrecipient')
