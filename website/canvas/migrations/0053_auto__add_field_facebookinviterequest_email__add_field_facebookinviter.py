...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookInviteRequest.email'
        db.add_column('canvas_facebookinviterequest', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'FacebookInviteRequest.first_name'
        db.add_column('canvas_facebookinviterequest', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'FacebookInviteRequest.last_name'
        db.add_column('canvas_facebookinviterequest', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookInviteRequest.email'
        db.delete_column('canvas_facebookinviterequest', 'email')

        # Deleting field 'FacebookInviteRequest.first_name'
        db.delete_column('canvas_facebookinviterequest', 'first_name')

        # Deleting field 'FacebookInviteRequest.last_name'
        db.delete_column('canvas_facebookinviterequest', 'last_name')
    ...
    models = {
        ...
        'canvas.facebookinviterequest': {
            'Meta': {'object_name': 'FacebookInviteRequest'},
