...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('canvas_invitecode', 'inviter', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='sent_invites', null=True, blank=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InviteCode.inviter'
        db.delete_column('canvas_invitecode', 'inviter_id')
