...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.posted_on_quest_of_the_day'
        db.add_column('canvas_comment', 'posted_on_quest_of_the_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.posted_on_quest_of_the_day'
        db.delete_column('canvas_comment', 'posted_on_quest_of_the_day')
