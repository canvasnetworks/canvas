...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('canvas_comment', 'score', self.gf('django.db.models.fields.FloatField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.score'
        db.delete_column('canvas_comment', 'score')
