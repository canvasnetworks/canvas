...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.allow_textonlyop'
        db.delete_column('canvas_category', 'allow_textonlyop')

        # Deleting field 'Category.disable_remix'
        db.delete_column('canvas_category', 'disable_remix')


    def backwards(self, orm):
        
        # Adding field 'Category.allow_textonlyop'
        db.add_column('canvas_category', 'allow_textonlyop', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Category.disable_remix'
        db.add_column('canvas_category', 'disable_remix', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
