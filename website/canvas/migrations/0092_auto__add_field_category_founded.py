...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.founded'
        db.add_column('canvas_category', 'founded', self.gf('django.db.models.fields.FloatField')(default=1298956320), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.founded'
        db.delete_column('canvas_category', 'founded')
