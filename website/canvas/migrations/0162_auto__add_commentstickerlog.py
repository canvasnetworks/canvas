...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommentStickerLog'
        db.create_table('canvas_commentstickerlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['canvas.Comment'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('canvas', ['CommentStickerLog'])


    def backwards(self, orm):
        
        # Deleting model 'CommentStickerLog'
        db.delete_table('canvas_commentstickerlog')
