...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmailUnsubscribe'
        db.create_table('canvas_emailunsubscribe', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('canvas', ['EmailUnsubscribe'])


    def backwards(self, orm):
        
        # Deleting model 'EmailUnsubscribe'
        db.delete_table('canvas_emailunsubscribe')
