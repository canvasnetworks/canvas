...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Content.remix_of'
        db.add_column('canvas_content', 'remix_of', self.gf('django.db.models.fields.related.ForeignKey')(related_name='remixes', null=True, to=orm['canvas.Content']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Content.remix_of'
        db.delete_column('canvas_content', 'remix_of_id')
