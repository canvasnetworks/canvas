...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.replied_comment'
        db.add_column('canvas_comment', 'replied_comment', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['canvas.Comment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.replied_comment'
        db.delete_column('canvas_comment', 'replied_comment_id')
