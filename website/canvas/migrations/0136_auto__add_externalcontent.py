...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('canvas_externalcontent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('source_url', self.gf('django.db.models.fields.CharField')(default='', max_length=4000, null=True, blank=True)),
            ('parent_comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='external_content', to=orm['canvas.Comment'])),
            ('_data', self.gf('django.db.models.fields.TextField')(default='{}')),
        ))
        db.send_create_signal('canvas', ['ExternalContent'])


    def backwards(self, orm):
        
        # Deleting model 'ExternalContent'
        db.delete_table('canvas_externalcontent')
