...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.bio_text'
        db.add_column('canvas_userinfo', 'bio_text', self.gf('django.db.models.fields.CharField')(default='', max_length=2000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.bio_text'
        db.delete_column('canvas_userinfo', 'bio_text')
