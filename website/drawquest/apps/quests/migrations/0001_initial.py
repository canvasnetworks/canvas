...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScheduledQuest'
        db.create_table('quests_scheduledquest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='scheduled_quests', to=orm['canvas.Comment'])),
            ('curator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='scheduled_quests', null=True, blank=True, to=orm['auth.User'])),
            ('timestamp', self.gf('canvas.util.UnixTimestampField')(default=0)),
            ('sort', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('quests', ['ScheduledQuest'])


    def backwards(self, orm):
        
        # Deleting model 'ScheduledQuest'
        db.delete_table('quests_scheduledquest')
    ...
    models = {
        ...
        'quests.scheduledquest': {
            ...
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'scheduled_quests'", 'to': "orm['canvas.Comment']"}),
