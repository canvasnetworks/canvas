...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Playback'
        db.create_table('playback_playback', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playbacks', to=orm['canvas.Comment'])),
        ...
        db.send_create_signal('playback', ['Playback'])


    def backwards(self, orm):
        
        # Deleting model 'Playback'
        db.delete_table('playback_playback')
